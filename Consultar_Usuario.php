...
$json=array();
    ...
    if(isset($_GET["ID_Usuario"])){
            ...
            $consulta="select ID_Usuario, Nombres, Apellidos,Direcccion,Fecha_Nacimiento,Nacionalidad,Telefono,Email,Contraseña,Tipo from Tbl_Usuario where ID_Usuario= '{$ID_Usuario}'";
